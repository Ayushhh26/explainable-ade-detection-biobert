...
REPO_URL = "https://github.com/Ayushhh26/explainable-ade-detection-biobert"
NOTEBOOK_URL = f"{REPO_URL}/blob/main/Extending_ADE_detection_with_Explainable_Counterfactuals_and_BioBERT_Final.ipynb"
...
def render_overview() -> None:
    ...
    st.markdown("Below are the canonical project links.")
